...
def TradeFunctionDaily(stock):
    ...
    if len(df_tradesignals) > 0:
        try:
            df_tradesignals[['PreVolume','PreHigh','PreBreakTime','HODTime','Price935','Price945','Price1000','Price1100','Price1300','Price1500']] = \
            ...
            df_tradesignals[['PreVolume','PreHigh','PreBreakTime','HODTime','Price935','Price945','Price1000','Price1100','Price1300','Price1500']] = np.nan
            print("failed to add intraday data for stock:", stock)
    else:
        pass
